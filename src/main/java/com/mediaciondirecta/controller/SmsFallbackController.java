...
public class SmsFallbackController {
    ...
    public PrepararSmsResponse prepararSms(@RequestHeader("Authorization") String authorizationHeader,
    ...
    public SmsContingenciaResponse sincronizarSms(@RequestHeader("Authorization") String authorizationHeader,
