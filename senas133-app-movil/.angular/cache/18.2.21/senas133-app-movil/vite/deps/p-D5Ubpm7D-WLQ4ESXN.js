...
var D = (o2, n, r, a, e2, s, d2 = false, c = 0, l3 = true) => __async(void 0, null, function* () {
  if (!r && !a) return;
...
var x = (t2, i3) => __async(void 0, null, function* () {
  if (void 0 === o) return;
  const l3 = "ios" === i3, f3 = "android" === i3, w2 = t2.getNumber("keyboardHeight", 290), m3 = t2.getBoolean("scrollAssist", true), y2 = t2.getBoolean("hideCaretOnScroll", l3), b2 = t2.getBoolean("inputBlurring", false), h2 = t2.getBoolean("scrollPadding", true), v2 = Array.from(o.querySelectorAll("ion-input, ion-textarea")), x2 = /* @__PURE__ */ new WeakMap(), K = /* @__PURE__ */ new WeakMap(), M = yield t.getResizeMode(), j = (n) => __async(void 0, null, function* () {
