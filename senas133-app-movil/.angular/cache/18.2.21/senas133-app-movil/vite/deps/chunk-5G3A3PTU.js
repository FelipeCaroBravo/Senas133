...
var r = (t3) => {
  ...
  const W2 = t3, I = [], K = [], M2 = [], P3 = [], Y = [], Z = [], q2 = [], x = [], H = [], z = [], B2 = [], G = "function" == typeof AnimationEffect || void 0 !== d2 && "function" == typeof d2.AnimationEffect, J = "function" == typeof Element && "function" == typeof Element.prototype.animate && G, L2 = () => B2, N = (e, o) => {
    ...
    (null == e ? void 0 : e.sync) && (k2 = true, O(() => k2 = false, {
      oneTimeCallback: true
    })), b2 || ie(), T && (J && (ne(0), re()), T = false), D2 && (S2 = Y.length + 1, D2 = false);
    const t4 = () => {
      N(i2, K), o();
    }, i2 = () => {
      N(t4, M2), o();
  ...
  return p2 = {
    ...
    destroy: (e) => (Y.forEach((o) => {
      ...
      Q(), e2 && U();
    })(e), P3.length = 0, Y.length = 0, y2.length = 0, I.length = 0, K.length = 0, b2 = false, D2 = true, p2),
    keyframes: (e) => {
      const o = y2 !== e;
      return y2 = e, o && ((e2) => {
        J && L2().forEach((o2) => {
    ...
    iterations: (e) => (d5 = e, ae(true), p2),
    duration: (e) => (J || 0 !== e || (e = 1), a = e, ae(true), p2),
    ...
    getEasing: $,
    getDuration: _,
    afterAddRead: (e) => (H.push(e), p2),
    afterAddWrite: (e) => (z.push(e), p2),
    afterClearStyles: (e = []) => {
      for (const o of e) R[o] = "";
      return p2;
    },
    afterStyles: (e = {}) => (R = e, p2),
    afterRemoveClass: (e) => (h2 = n2(h2, e), p2),
    afterAddClass: (e) => (E2 = n2(E2, e), p2),
    beforeAddRead: (e) => (q2.push(e), p2),
    beforeAddWrite: (e) => (x.push(e), p2),
    beforeClearStyles: (e = []) => {
      for (const o of e) C2[o] = "";
      return p2;
    },
    beforeStyles: (e = {}) => (C2 = e, p2),
    beforeRemoveClass: (e) => (A2 = n2(A2, e), p2),
    beforeAddClass: (e) => (g2 = n2(g2, e), p2),
    onFinish: O,
    isRunning: () => 0 !== S2 && !F,
    progressStart: (e = false, o) => (Y.forEach((t4) => {
      t4.progressStart(e, o);
    }), se(), j2 = e, b2 || ie(), ae(false, true, o), p2),
    progressStep: (e) => (Y.forEach((o) => {
      o.progressStep(e);
    }), ne(e), p2),
    progressEnd: (e, o, t4) => (j2 = false, Y.forEach((i2) => {
...
var y = (n3) => __async(void 0, null, function* () {
  if (n3.leavingEl && n3.animated && 0 !== n3.duration) return n3.animationBuilder ? n3.animationBuilder : "ios" === n3.mode ? (yield import("./p-C1aScSTo-V7TQUFT7.js")).iosTransitionAnimation : (yield import("./p-DIE4pXMl-WQIZHGMX.js")).mdTransitionAnimation;
});
var h = (n3, e) => __async(void 0, null, function* () {
  yield k(e, true);
  const i2 = n3(e.baseEl, e);
  j(e.enteringEl, e.leavingEl);
  const a = yield V(i2, e);
...
var P2 = (e) => __async(void 0, null, function* () {
  ...
  return yield k(e, o), j(i2, a), E(i2, a), {
    hasCompleted: true
  };
});
var k = (n3, e) => __async(void 0, null, function* () {
  (void 0 !== n3.deepWait ? n3.deepWait : e) && (yield Promise.all([D(n3.enteringEl), D(n3.leavingEl)])), yield C(n3.viewIsReady, n3.enteringEl);
});
...
var D = (n3) => __async(void 0, null, function* () {
  const e = n3;
  if (e) {
    ...
    yield Promise.all(Array.from(e.children).map(D));
  }
});
var L = (n3, e) => {
...
@ionic/core/components/p-CtukzcyX.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-5G3A3PTU.js.map
