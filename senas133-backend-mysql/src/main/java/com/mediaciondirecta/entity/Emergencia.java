...
public class Emergencia {
    ...
    @Column(nullable = false)
    private boolean detallePosteriorPendiente;

    private Boolean lugarSeguroParaMasInformacion;
    ...
    private LocalDateTime patrullaDespachadaEn;
    ...
    public boolean isDetallePosteriorPendiente() { return detallePosteriorPendiente; }
    public void setDetallePosteriorPendiente(boolean detallePosteriorPendiente) { this.detallePosteriorPendiente = detallePosteriorPendiente; }
    public Boolean getLugarSeguroParaMasInformacion() { return lugarSeguroParaMasInformacion; }
    public void setLugarSeguroParaMasInformacion(Boolean lugarSeguroParaMasInformacion) { this.lugarSeguroParaMasInformacion = lugarSeguroParaMasInformacion; }
    ...
    public LocalDateTime getRecibidaEn() { return recibidaEn; }
    public void setRecibidaEn(LocalDateTime recibidaEn) { this.recibidaEn = recibidaEn; }
    public LocalDateTime getPatrullaDespachadaEn() { return patrullaDespachadaEn; }
    public void setPatrullaDespachadaEn(LocalDateTime patrullaDespachadaEn) { this.patrullaDespachadaEn = patrullaDespachadaEn; }
